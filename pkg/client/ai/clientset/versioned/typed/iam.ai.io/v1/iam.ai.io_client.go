...
import (
	...
	"github.com/wongearl/go-restful-template/pkg/client/ai/clientset/versioned/scheme"
...
// IamV1Client is used to interact with features provided by the iam.ai.io group.
type IamV1Client struct {
	restClient rest.Interface
}

func (c *IamV1Client) GlobalRoles() GlobalRoleInterface {
	return newGlobalRoles(c)
}

func (c *IamV1Client) GlobalRoleBindings() GlobalRoleBindingInterface {
...
// NewForConfigAndClient creates a new IamV1Client for the given config and http client.
...
// NewForConfigOrDie creates a new IamV1Client for the given config and
